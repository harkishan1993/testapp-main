    ...
    return (
        <div className="flex flex-col gap-8">
            <motion.div className="cursor-pointer" layoutId={1} onClick={handle} >
                <div className="border-[2px] flex flex-col gap-1 justify-center  items-center hover:bg-sky-800 border-white px-10 py-3 bg- rounded-full">
            ...
            <AnimatePresence>
                { selectedId && (<motion.div className="flex flex-col gap-2" layoutId={selectedId}>
                    <motion.span onClick={handle} className="text-2xl hover:text-red-700 cursor-pointer"><AiFillCloseSquare/></motion.span>
