    ...
    <Homecontainer>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='flex flex-col items-center justify-center gap-4 order-2 md:order-1'>
                ...
                <p className='textbase textset'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minima error adipisci consequatur consectetur delectus dolore, nam, nihil quo architecto vero voluptatem, quia dolor dignissimos laborum perferendis! Modi fugit repudiandae ratione.</p>
